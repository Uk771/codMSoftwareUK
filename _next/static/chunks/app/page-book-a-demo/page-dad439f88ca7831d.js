(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [2078],
  {
    51245: function (e, s, t) {
      Promise.resolve().then(t.bind(t, 58273));
    },
    58273: function (e, s, t) {
      "use strict";
      t.r(s),
        t.d(s, {
          default: function () {
                                ...
                                children: [
                                  (0, i.jsxs)("span", {
                                    ...
                                    children: [
                                      ...
                                      (0, i.jsx)("span", { children: "k" }),
                                    ],
                                  }),
                                  (0, i.jsx)("p", { children: "New accounts" }),
                                ],
                              }),
                            }),
                          }),
                            ...
                            children: (0, i.jsx)("div", {
                              ...
                              children: (0, i.jsxs)("div", {
                                ...
                                children: [
                                  ...
                                  (0, i.jsx)("p", { children: "Media posts" }),
                                ],
                              }),
                            }),
                          }),
                        ...
                        children: [
                          (0, i.jsx)("div", {
                            ...
                            children: (0, i.jsxs)("div", {
                              ...
                              children: [
                                (0, i.jsx)("h6", { children: "Trial Plan" }),
                                (0, i.jsx)("p", {
                                  className: "fs-7",
                          ...
                          (0, i.jsx)("div", {
                            ...
                            children: (0, i.jsxs)("div", {
                              ...
                              children: [
                                (0, i.jsx)("h6", { children: "Enterprise" }),
                                (0, i.jsx)("p", {
                                  className: " fs-7",
          ...
          function e(e, s, t) {
            ...
            (this.endVal = s),
              ...
              (this.count = function (e) {
                ...
                var s = e - n.startTime;
                (n.remaining = n.duration - s),
                  n.useEasing
                    ? n.countDown
                      ? (n.frameVal =
                          n.startVal -
                          n.easingFn(s, 0, n.startVal - n.endVal, n.duration))
                    ...
                    : (n.frameVal =
                        n.startVal +
                        (n.endVal - n.startVal) * (s / n.duration));
                var t = n.countDown
                  ? n.frameVal < n.endVal
                  : n.frameVal > n.endVal;
              ...
              (this.formatNumber = function (e) {
                var s,
                  t,
                  i,
                  r = (Math.abs(e).toFixed(n.options.decimalPlaces) + "").split(
                    "."
                  );
                if (
                  ((s = r[0]),
                  (t = r.length > 1 ? n.options.decimal + r[1] : ""),
                  n.options.useGrouping)
                ) {
                  i = "";
                  for (var a = 3, l = 0, c = 0, o = s.length; c < o; ++c)
                    n.options.useIndianSeparators &&
                      4 === c &&
                      ((a = 2), (l = 1)),
                      0 !== c && l % a == 0 && (i = n.options.separator + i),
                      l++,
                      (i = s[o - c - 1] + i);
                  s = i;
                }
            ...
            (e.prototype.handleScroll = function (e) {
              if (e && window && !e.once) {
                var s = window.innerHeight + window.scrollY,
                  ...
                  n = t.top + t.height + window.pageYOffset;
                n < s && n > window.scrollY && e.paused
                  ? ((e.paused = !1),
                    setTimeout(function () {
                      return e.start();
                    }, e.options.scrollSpyDelay),
                    e.options.scrollSpyOnce && (e.once = !0))
                  : (window.scrollY > n || i > s) && !e.paused && e.reset();
              }
            }),
    ...
    77095: function (e, s, t) {
      ...
      var m = function (e, s) {
          var t = s.decimal,
            ...
            p = s.useEasing,
            f = s.useGrouping,
            x = s.useIndianSeparators,
            g = s.enableScrollSpy,
            j = s.scrollSpyDelay,
            C = s.scrollSpyOnce,
            b = s.plugin;
          return new n.CountUp(e, l, {
            startVal: m,
            duration: r,
            decimal: t,
            decimalPlaces: i,
        ...
        f = function (e) {
          var s = Object.fromEntries(
            ...
            N = i.useRef(!1),
            y = h(function () {
              return m("string" == typeof n ? n : n.current, b);
            }),
            k = h(function (e) {
              var s = v.current;
              if (s && !e) return s;
            ...
            L = h(function () {
              var e = function () {
                return k(!0).start(function () {
                  null == f ||
                    f({ pauseResume: V, reset: S, start: E, update: M });
                });
              };
              d && d > 0 ? (w.current = setTimeout(e, 1e3 * d)) : e(),
                null == x || x({ pauseResume: V, reset: S, update: M });
            }),
            V = h(function () {
              k().pauseResume(),
                null == g || g({ reset: S, start: E, update: M });
            }),
            S = h(function () {
              k().el &&
                (w.current && clearTimeout(w.current),
                k().reset(),
                null == j || j({ pauseResume: V, start: E, update: M }));
            }),
            M = h(function (e) {
              k().update(e),
                null == C || C({ pauseResume: V, reset: S, start: E });
            }),
            E = h(function () {
              S(), L();
            }),
          ...
          return (
            ...
            { start: E, pauseResume: V, reset: S, update: M, getCountUp: k }
          );
        },
