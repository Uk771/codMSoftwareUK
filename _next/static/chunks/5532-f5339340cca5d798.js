      ...
      var d = function (t, e) {
        ...
        h = function (t) {
            ...
            j = f(function () {
              var t = function () {
                return x(!0).start(function () {
                  null == h ||
                    h({ pauseResume: F, reset: R, start: C, update: P });
                });
              };
              c && c > 0 ? (V.current = setTimeout(t, 1e3 * c)) : t(),
                null == y || y({ pauseResume: F, reset: R, update: P });
            }),
            F = f(function () {
              x().pauseResume(),
                null == g || g({ reset: R, start: C, update: P });
            }),
            R = f(function () {
              x().el &&
                (V.current && clearTimeout(V.current),
                x().reset(),
                null == v || v({ pauseResume: F, start: C, update: P }));
            }),
            P = f(function (t) {
              x().update(t),
                null == b || b({ pauseResume: F, reset: R, start: C });
            }),
            C = f(function () {
              R(), j();
            }),
          ...
          return (
            ...
            { start: C, pauseResume: F, reset: R, update: P, getCountUp: x }
          );
        },
      ...
      let a = r.forwardRef(function (t, e) {
          ...
          N = r.useCallback(() => {
            if (A.current && C.current) {
              let t = C.current.getBoundingClientRect(),
                e = A.current.getBoundingClientRect(),
                n = t.width,
                r = e.width;
              ("up" === c || "down" === c) && ((n = t.height), (r = e.height)),
                o && n && r ? j(r < n ? Math.ceil(n / r) : 1) : j(1),
                V(n),
                S(r);
            }
          }, [o, C, c]);
        r.useEffect(() => {
          if (F && (N(), A.current && C.current)) {
        ...
        let M = r.useMemo(
          ...
          D = r.useMemo(
            () => ({
              "--gradient-color": h,
              "--gradient-width": "number" == typeof y ? "".concat(y, "px") : y,
            }),
            [h, y]
          ),
          T = r.useMemo(
